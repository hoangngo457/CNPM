...
namespace WebApplication1.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idOrder,idProduct,date,quantity,status,addressDelivery,price")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idOrder,idProduct,date,quantity,status,addressDelivery,price")] Order order)
        {
            if (ModelState.IsValid)
            {
